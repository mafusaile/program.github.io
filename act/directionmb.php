...
$samples = "SELECT * FROM `sampleswater` WHERE `Номер акта отбора` = $actnumber AND `Дата` = '$date' AND `Лаборатория` LIKE '%м/б%'";
    ...
    <div id='wrapper'>
			<div class='content'>
                ...
                <table id='table' style='width:1200px;border:none;'>
				            ...
				            <tr>
                                <?php 
                                    $mbgosts = "SELECT * FROM `gosts` WHERE `Назначение` LIKE 'отбор проб / вода' AND `Лаборатория` LIKE 'м/б'";
